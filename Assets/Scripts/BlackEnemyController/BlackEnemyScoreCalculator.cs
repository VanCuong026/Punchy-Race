...
public class BlackEnemyScoreCalculator : MonoBehaviour
{
    public static BlackEnemyScoreCalculator instance;
    [SerializeField]
        ...
        if (other.tag == "PurpleStar")
        {
            ...
            if (transform.position.z > 30f)
            {
                ...
                while (_Counting < 1)
                {
                    ...
                    if (SecondMapSpawner1.instance._TypeOfitem[_X, _Z] == 3 || SecondMapSpawner1.instance._TypeOfitem[_X, _Z] == 1)
                    {
